...
class ABotSpeaker extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		bg = new FlxSprite(90, 20).loadGraphic(Paths.image('stages/phillyStreets/abot/stereoBG'));
		bg.antialiasing = antialias;
		add(bg);

		var vizX:Float = 0;
		var vizY:Float = 0;
		var vizFrames = Paths.getSparrowAtlas('stages/phillyStreets/abot/aBotViz');
		...
		Paths.loadAnimateAtlas(eyes, 'stages/phillyStreets/abot/systemEyes');
		...
		Paths.loadAnimateAtlas(speaker, 'stages/phillyStreets/abot/abotSystem');
