...
class ModchartEditorState extends MusicBeatState
{
	...
	function setupModifierUI()
	{
		...
		var modClassDropDown = new FlxUIDropDownMenuCustom(modClassInputText.x, modClassInputText.y + 30,
			FlxUIDropDownMenuCustom.makeStrIdLabelArray(modClassList, true), function(mod:String)
		{
		...
		var modTypeDropDown = new FlxUIDropDownMenuCustom(modTypeInputText.x, modClassInputText.y + 30,
			FlxUIDropDownMenuCustom.makeStrIdLabelArray(modTypeList, true), function(mod:String)
		{
	...
	function setupEventUI()
	{
		...
		easeDropDown = new FlxUIDropDownMenuCustom(25, eventEaseInputText.y + 30, FlxUIDropDownMenuCustom.makeStrIdLabelArray(easeList, true),
