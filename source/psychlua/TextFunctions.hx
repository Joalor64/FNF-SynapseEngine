...
class TextFunctions
{
	public static function implement(funk:FunkinLua)
	{
		...
		Lua_helper.add_callback(lua, "setTextHeight", function(tag:String, height:Float)
		{
			...
			LuaUtils.luaTrace(lua, "setTextHeight: Object " + tag + " doesn't exist!", false, false, FlxColor.RED);
			return false;
		});
		Lua_helper.add_callback(lua, "setTextAutoSize", function(tag:String, value:Bool)
		{
			...
			LuaUtils.luaTrace(lua, "setTextAutoSize: Object " + tag + " doesn't exist!", false, false, FlxColor.RED);
			return false;
		});
