...
class DeprecatedFunctions
{
	public static function implement(funk:FunkinLua)
	{
		...
		{
			LuaUtils.luaTrace(lua, "addAnimationByIndicesLoop is deprecated! Use addAnimationByIndices instead", false, true);
		...
		Lua_helper.add_callback(lua, "updateHitboxFromGroup", function(group:String, index:Int)
		{
			...
			LuaUtils.luaTrace(lua, 'updateHitboxFromGroup is deprecated! Use updateHitbox instead.', false, true);
		});
	}
}
